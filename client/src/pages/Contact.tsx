        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-8">
              {language === "jp" &&
                "テクノピアへのご連絡をお待ちしております。"}
              {language === "ko" && "모두의 연락을 기다리고 있습니다."}
              {language === "en" &&
                "We are waiting for your contact with all our hearts."}
              ...
              <CardContent>
                <form onSubmit={handleSubmitContact} className="space-y-6">
                    ...
                    <Select name="department" defaultValue="">
                      ...
                      <SelectContent>
                        <SelectItem value="hr-recruitment">
                          {language === "jp" && "人事採用部"}
                          {language === "ko" && "인사채용부"}
                          {language === "en" && "HR Recruitment Department"}
                          {language === "zh" && "人事招聘部"}
                        </SelectItem>
                        <SelectItem value="medical">
                          {language === "jp" && "メディカル事業部"}
                          {language === "ko" && "메디컬 사업부"}
                          {language === "en" && "Medical Business Division"}
                          {language === "zh" && "医疗事业部"}
                        </SelectItem>
                        <SelectItem value="auto">
                          {language === "jp" && "AUTO事業部"}
                          {language === "ko" && "AUTO 사업부"}
                          {language === "en" && "AUTO Business Division"}
                          {language === "zh" && "AUTO事业部"}
                        </SelectItem>
                  ...
                  <Button
                    ...
                    className="w-full bg-corporate-blue hover:bg-blue-700                                   text-white"
                    size="lg"
                  >
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-slate-600 space-y-1">
                        ...
                        <p>
                          {language === "jp" &&
                            "メディカル事業部 : 03-3221-5177"}
                          {language === "ko" && "메디컬사업부 : 03-3221-5177"}
                          {language === "en" &&
                            "Medical Division : 03-3221-5177"}
                        ...
                        <p>
                          ...
                          {language === "en" &&
                            "New Business Division : 03-3221-4761"}
                      ...
                      <div className="flex items-center space-x-3">
                        <div className="flex space-x-1">
                          <div
                            ...
                            style={{ backgroundColor: "#8f76d6" }}
                            title="半蔵門線"
                          ></div>
                          <div
                            className="w-3 h-3 rounded-full"
                            style={{ backgroundColor: "#6cbb5a" }}
                            title="新宿線"
                          ></div>
                        </div>
                        <p>
                          {language === "jp" &&
                            "東京メトロ半蔵門線・都営新宿線「神保町」駅 徒歩 3 分"}
                          {language === "ko" &&
                            "도쿄메트로 한조몬선·도영 신주쿠선「진보초」역 도보 3분"}
                          {language === "en" &&
                            'Tokyo Metro Hanzomon Line / Toei Shinjuku Line "Jimbocho" Station - 3 min walk'}
                          {language === "zh" &&
                            "东京地铁半蔵门线·都营新宿线「神保町」站 步行3分钟"}
                        </p>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="flex space-x-1">
                        ...
                        <p>
                          {language === "jp" &&
                            "東京メトロ半蔵門線・東西線・都営新宿線「九段下」駅 徒歩 3 分"}
                          {language === "ko" &&
                            "도쿄메트로 한조몬선·도자이선·도영 신주쿠선「구단시타」역 도보 3분"}
                          {language === "en" &&
                            'Tokyo Metro Hanzomon Line / Tozai Line / Toei Shinjuku Line "Kudanshita" Station - 3 min walk'}
                          {language === "zh" &&
                            "东京地铁半蔵门线·东西线·都营新宿线「九段下」站 步行3분钟"}
                        </p>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="flex space-x-1">
                        ...
                        <p>
                          {language === "jp" &&
                            "JR 総武線「水道橋」駅 徒歩 7 分"}
                          {language === "ko" &&
                            "JR 소부선「스이도바시」역 도보 7분"}
                          {language === "en" &&
                            'JR Sobu Line "Suidobashi" Station - 7 min walk'}
                          {language === "zh" &&
                            "JR总武线「水道桥」站 步행7분钟"}
                        </p>
                      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-slate-600">
                  {language === "jp" &&
                    "通常、営業日3日以内にご回答いたします。緊急の場合は、お電話でお問い合わせください。"}
                  {language === "ko" &&
                    "일반적으로 영업일 3일 이내에 답변드립니다. 긴급한 경우는 전화로 문의해 주세요."}
                  {language === "en" &&
                    "We usually respond within 3 business days. For urgent matters, please contact us by phone."}
                  {language === "zh" &&
                    "通常在3个工作日内回复。紧急情况请电话联系。"}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold text-slate-900 mb-3">
                  ...
                  {language === "en" &&
                    "What happens to inquiries outside business hours?"}
                  {language === "zh" && "营业时间外的咨询如何处理？"}
                </h3>
                <p className="text-slate-600">
                  {language === "jp" &&
                    "営業時間外にいただいたお問い合わせは、翌営業日に確認・対応いたします。"}
                  {language === "ko" &&
                    "영업시간 외에 받은 문의는 다음 영업일에 확인·대응합니다."}
                  {language === "en" &&
                    "Inquiries received outside business hours will be reviewed and responded to on the next business day."}
                  {language === "zh" &&
                    "营业时间外收到的咨询将在下一个工作日确认并回复。"}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-slate-600">
                  {language === "jp" &&
                    "はい、お問い合わせフォームまたはお電話でご請求ください。デジタル版も提供しております。"}
                  {language === "ko" &&
                    "네, 문의 양식이나 전화로 요청해 주세요. 디지털 버전도 제공합니다."}
                  {language === "en" &&
                    "Yes, please request through the inquiry form or by phone. Digital versions are also available."}
                  {language === "zh" &&
                    "是的，请通过咨询表格或电话申请。我们也提供数字版本。"}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold text-slate-900 mb-3">
                  {language === "jp" &&
                    "海外からのお問い合わせも受け付けていますか？"}
                  {language === "ko" && "해외에서의 문의도 받고 있나요?"}
                  {language === "en" &&
                    "Do you accept inquiries from overseas?"}
                  {language === "zh" && "接受海外咨询吗？"}
                </h3>
                <p className="text-slate-600">
                  {language === "jp" &&
                    "はい、グローバルに事業を展開しておりますので、海外からのお問い合わせも歓迎いたします。"}
                  {language === "ko" &&
                    "네, 글로벌하게 사업을 전개하고 있어 해외 문의도 환영합니다."}
                  {language === "en" &&
                    "Yes, we operate globally and welcome inquiries from overseas."}
                  {language === "zh" &&
                    "是的，我们在全球开展业务，欢迎海外咨询。"}
                </p>
              </CardContent>
